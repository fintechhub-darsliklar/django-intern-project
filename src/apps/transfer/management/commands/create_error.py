...
from apps.transfer.models import Error  # 'your_app' ni o'z app nomingizga o'zgartiring

class Command(BaseCommand):
    help = 'Bazani standart xatolik xabarlari bilan toldiradi'
    ...
    def handle(self, *args, **kwargs):
        ...
        created_count = 0
        for code, en, ru, uz in error_data:
        ...
        self.stdout.write(
            self.style.SUCCESS(f'Muvaffaqiyatli yakunlandi! {created_count} ta yangi xatolik qo\'shildi.')
        )